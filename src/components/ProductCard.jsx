...
const ProductCard = ({ name, description, price, href, delay = 0 }) => {
  return (
    <motion.div
    ...
    >
      <div className="flex-1">
        <h3 className="text-3xl font-black font-heading mb-4">{name}</h3>
        <p className="text-lg font-medium text-muted-foreground mb-6">{description}</p>

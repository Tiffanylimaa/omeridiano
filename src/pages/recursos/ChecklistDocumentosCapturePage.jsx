...
import { Check, CheckCircle2, Mail, FileText } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { Label } from '@/components/ui/label';
import pb from '@/lib/pocketbaseClient.js';

const ChecklistDocumentosCapturePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await pb.collection('leads').create({
        ...
        lead_magnet_id: 'checklist-documentos'
      }, { $autoCancel: false });
  ...
  const countries = [
    { name: 'EUA', docs: ['Passaporte válido', 'Visto', 'I-20/DS-2019', 'Comprovante financeiro'] },
    { name: 'China', docs: ['Passaporte válido', 'Visto', 'JW202/JW201', 'Exame médico'] },
    { name: 'Canadá', docs: ['Passaporte válido', 'eTA/Visto', 'Letter of Acceptance', 'Proof of Funds'] },
    { name: 'Coreia', docs: ['Passaporte válido', 'Visto D-2/D-4', 'Certificate of Admission', 'Apostila de documentos'] },
    { name: 'Europa', docs: ['Passaporte válido', 'Visto Schengen/Nacional', 'Carta de aceitação', 'Seguro saúde'] }
  ];

  return (
    <div className="min-h-screen bg-background pt-32 pb-24">
      <Helmet>
        <title>Checklist de Documentos por País - Gratuito | O Meridiano</title>
        <meta name="description" content="Saiba exatamente quais documentos você precisa para cada destino. Checklist completo para EUA, China, Canadá, Coreia e Europa." />
      </Helmet>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Saiba exatamente o que você precisa para cada destino
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-3xl font-black font-heading">Checklist Interativo por País:</h2>
            </div>
            <div className="space-y-6">
              {countries.map((country, i) => (
                <div key={i} className="border-[3px] border-black rounded-xl p-4 bg-secondary">
                  <h3 className="text-xl font-black font-heading mb-3">{country.name}</h3>
                  <ul className="space-y-2">
                    {country.docs.map((doc, j) => (
          ...
          >
            {status === 'success' ? (
              <div className="text-center">
                ...
                <p className="text-lg font-bold mb-6">Verifique seu e-mail para acessar o checklist completo em PDF com todos os documentos por país.</p>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <p className="text-sm font-medium text-center">
                    Ao enviar, você concorda em receber e-mails com conteúdos sobre viagens e mobilidade internacional.
                  </p>
                </form>
              </>
            )}
...
export default ChecklistDocumentosCapturePage;
